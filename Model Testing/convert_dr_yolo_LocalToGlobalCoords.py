...
IN_FILE = 'C:/Users/anton/Desktop/mAP-master/scripts/extra/resultBoan+CubesOnPanoSlidesTest.txt'
            ...
            if path_full_name.is_file():
                ...
                if path_full_name.is_file():
                    ...
                    if conf1 < 0:
                        ...
                        if filePath.is_file():
                            os.remove(full_name)
                    if x1 % 240 == 0 or y1 % 240 == 0 or x2 % 240 == 0 or y2 % 240 == 0:
                        print("detection at the edge")
                        filePath = Path(full_name)
                        if filePath.is_file():
                            os.remove(full_name)
                    if (x1+margin1) % 240 == 0 or (y1+margin1) % 240 == 0 or (x2+margin1) % 240 == 0 or (y2+margin1) % 240 == 0 or (x1-margin1) % 240 == 0 or (y1-margin1) % 240 == 0 or (x2-margin1) % 240 == 0 or (y2-margin1) % 240 == 0:
                        print("detection almost at the edge")
                        filePath = Path(full_name)
                        if filePath.is_file():
                            os.remove(full_name)
                    if (x1+margin2) % 240 == 0 or (y1+margin2) % 240 == 0 or (x2+margin2) % 240 == 0 or (y2+margin2) % 240 == 0 or (x1-margin2) % 240 == 0 or (y1-margin2) % 240 == 0 or (x2-margin2) % 240 == 0 or (y2-margin2) % 240 == 0:
                        print("detection almost at the edge")
                        filePath = Path(full_name)
                        if filePath.is_file():
                            os.remove(full_name)
                    if (x1+margin3) % 240 == 0 or (y1+margin3) % 240 == 0 or (x2+margin3) % 240 == 0 or (y2+margin3) % 240 == 0 or (x1-margin3) % 240 == 0 or (y1-margin3) % 240 == 0 or (x2-margin3) % 240 == 0 or (y2-margin3) % 240 == 0:
                        print("detection almost at the edge")
                        filePath = Path(full_name)
                        if filePath.is_file():
                            print("Deleting",full_name,"because margin3 exceeded")
                            os.remove(full_name)
